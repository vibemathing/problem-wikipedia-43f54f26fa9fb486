...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-43f54f26fa9fb486"
    ],
    "allowed_axioms": [
    ...
    "domain": {
      "description": "Draft source observation in Model theory and formal languages; domain extraction is unresolved.",
      "objects": [
    ...
    "problem_id": "problem:wikipedia-43f54f26fa9fb486",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-43f54f26fa9fb486",
        "url": "https://en.wikipedia.org/wiki/Vaught_conjecture"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Vaught conjecture : the number of countable models of a first-order complete theory in a countable language is either finite, $\\aleph _{0}$ , or $2^{\\aleph _{0}}$ .",
      "version": 1
    },
    "title": "Vaught conjecture",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "056187fe1a46e5d162873f19f8ce14dceb3dfe9fa1b9123911921516ef6db651"
}
```
